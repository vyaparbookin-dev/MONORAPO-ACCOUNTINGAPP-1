...
// Re-wired screens that became unreachable
...
export default function SettingsNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: true }}>
      <Stack.Screen name="SettingsHome" component={MoreSettingsScreen} options={{ title: 'More Options' }} />
      <Stack.Screen name="BasicSettings" component={SettingsScreen} options={{ title: 'Basic Settings' }} />
      ...
      {/* Salary */}
      <Stack.Screen name="StaffManagement" component={StaffManagementScreen} options={{ title: 'Staff & Role Management' }} />
