    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={['#5B3FD0']} />}>
        ...
        <View style={styles.gridContainer}>
          <GridCard title="Stock Value" amount={`₹ ${summary.stockValue.toLocaleString('en-IN')}`} icon="cube-outline" iconColor="#64748B" bg="#FFFFFF" onPress={() => openNestedTab('Items')} />
          ...
          <GridCard title="Low Stock Alerts" amount={`${summary.lowStockCount} Items`} icon="warning-outline" iconColor="#EF4444" bg="#FFF1F2" onPress={() => openNestedTab('Items')} actionText={summary.lowStockCount > 0} />
