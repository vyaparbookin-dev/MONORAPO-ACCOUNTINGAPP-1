...
export const bulkImportProducts = async (req, res) => {
  try {
    ...
    const bulkOps = validatedProducts.map(item => {
      ...
      // DO NOT force ObjectId on companyId, it causes mismatch if schema uses String
      updateFields.companyId = item.companyId;
    ...
    if (result) {
        ...
        console.log(`🚀 [DEBUG RAW COUNTS]`, JSON.stringify({
            inserted: finalInserted, updated: finalUpdated, matched: finalMatched
        }));
    }
