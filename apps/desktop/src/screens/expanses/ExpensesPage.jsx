  ...
  const handleAddExpense = async (e) => {
    ...
    try {
      ...
      if (editingId) {
        ...
        await syncQueue.enqueue({ entityId: editingId, entity: 'expense', method: "PUT", url: `/api/expance/${editingId}`, data: payload });
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Delete this expense?")) {
      try {
        ...
        await syncQueue.enqueue({ entityId: id, entity: 'expense', method: "DELETE", url: `/api/expance/${id}` });
